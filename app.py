...
if remote is True: # Config remote database and remote oauth host
    ...
    host_config = 'http://herokuoauth2019.herokuapp.com/auth/google/callback'
...
# GOOGLE API OAUTH2
# Google API Token 
app_id = '197275234442-bgladhlsr3rnfea7tuan0tug7v9l3vs3.apps.googleusercontent.com'
app_secret = 'QIkmpvD5k4stKj_Ne_3DGgW0'
